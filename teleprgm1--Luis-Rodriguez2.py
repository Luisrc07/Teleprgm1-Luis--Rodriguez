vtupla1dato = ("mi nombre es luis alfonso rodriguez carrasquero"),
print("tengo muchas cualidades que si las usos bien sere un profesional", vtupla1dato)
...
print("todas las edades son:", vIndice)